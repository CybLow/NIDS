...
public:
  ...
  [[nodiscard]] std::unordered_set<std::string, std::hash<std::string>,
                                   std::equal_to<>>
  getUniqueServices() const;
  ...
  resolveApplication(std::uint16_t filterSrcPort, std::uint16_t filterDstPort,
