...
TEST_F(ThreatIntelProviderTest, loadFeeds_jsonFileSkipped) {
    writeFeedFile("data.json", R"({"ips": ["1.1.1.1"]})");  // JSON extension → skip
...
TEST_F(ThreatIntelProviderTest, loadFeeds_ipWithLeadingTrailingWhitespace_trimmed) {
    // IP with surrounding whitespace — exercises stripWhitespace trim branch (line 24-25)
...
TEST_F(ThreatIntelProviderTest, loadFeeds_lineEmptyAfterExtractIpField_skipped) {
